...
![png](images/float-8.625转二进制.png)
...
![png](images/float-0.1转换成二进制.png)
...
![png](images/float-IEEE制定的浮点数国际标准.png)
...
![png](images/float-float的二进制浮点数转换成十进制公式.png)

举个例子，我们把下图这个 float 的数据转换成十进制，过程如下：

![png](images/float-float的数据转换成十进制过程.png)
