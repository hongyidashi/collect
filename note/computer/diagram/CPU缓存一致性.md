...
- [一、CPU Cache 的数据写入](#%E4%B8%80cpu-cache-%E7%9A%84%E6%95%B0%E6%8D%AE%E5%86%99%E5%85%A5)
    - [1. 写直达](#1-%E5%86%99%E7%9B%B4%E8%BE%BE)
    - [2. 写回](#2-%E5%86%99%E5%9B%9E)
- [二、缓存一致性问题](#%E4%BA%8C%E7%BC%93%E5%AD%98%E4%B8%80%E8%87%B4%E6%80%A7%E9%97%AE%E9%A2%98)
- [三、总线嗅探](#%E4%B8%89%E6%80%BB%E7%BA%BF%E5%97%85%E6%8E%A2)
- [四、MESI 协议](#%E5%9B%9Bmesi-%E5%8D%8F%E8%AE%AE)
...
![png](images/CPUCC-CPU组成示意图.png)

我们当然期望 CPU 读取数据的时候，都是尽可能地从 CPU Cache 中读取，而不是每一次都要从内存中获取数据。所以，身为程序员，我们要尽可能写出缓存命中率高的代码，这样就有效提高程序的性能，具体的做法，不说。
...
![png](images/CPUCC-MESI协议状态图.png)

MESI 协议的四种状态之间的流转过程，汇总成下面的表格，可以更详细的看到每个状态转换的原因：

![png](images/CPUCC-MESI协议状态之间流转过程.png)
