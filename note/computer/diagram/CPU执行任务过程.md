...
- [一、CPU 如何读写数据的？](#%E4%B8%80cpu-%E5%A6%82%E4%BD%95%E8%AF%BB%E5%86%99%E6%95%B0%E6%8D%AE%E7%9A%84)
    - [1. 分析伪共享的问题](#1-%E5%88%86%E6%9E%90%E4%BC%AA%E5%85%B1%E4%BA%AB%E7%9A%84%E9%97%AE%E9%A2%98)
    - [2. 避免伪共享的方法](#2-%E9%81%BF%E5%85%8D%E4%BC%AA%E5%85%B1%E4%BA%AB%E7%9A%84%E6%96%B9%E6%B3%95)
- [二、CPU 如何选择线程的？](#%E4%BA%8Ccpu-%E5%A6%82%E4%BD%95%E9%80%89%E6%8B%A9%E7%BA%BF%E7%A8%8B%E7%9A%84)
    - [1. 调度类](#1-%E8%B0%83%E5%BA%A6%E7%B1%BB)
    - [2. 完全公平调度](#2-%E5%AE%8C%E5%85%A8%E5%85%AC%E5%B9%B3%E8%B0%83%E5%BA%A6)
    - [3. CPU 运行队列](#3-cpu-%E8%BF%90%E8%A1%8C%E9%98%9F%E5%88%97)
    - [4. 调整优先级](#4-%E8%B0%83%E6%95%B4%E4%BC%98%E5%85%88%E7%BA%A7)
...
![png](images/CPUTP-金字塔存储层次.png)

从上图也可以看到，从上往下，存储设备的容量会越大，而访问速度会越慢。至于每个存储设备的访问延时，你可以看下图的表格：

![png](images/CPUTP-存储设备容量和价格图.png)
...
至于 CPU Line 大小，在 Linux 系统可以用下面的方式查看到，可以看我的 L1 Cache Line 大小是 64 字节，也就意味着 **L1 Cache 一次载入数据的大小是 64 字节**。

![png](images/CPUTP-查看L1缓存大小.png)
...
![png](images/CPUTP-__cacheline_aligned_in_smp宏定义.png)
...
![png](images/CPUTP-RingBuffer类.png)
...
![png](images/CPUTP-java填充的办法.png)
...
![png](images/CPUTP-Linux内核任务调度.png)
...
![png](images/CPUTP-完全公平调度-调度时间.png)
