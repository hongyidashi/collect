...
![png](images/1-执行计划显示列.png)

说实话，sql语句没有走索引，排除没有建索引之外，最大的可能性是索引失效了。

如果你想进一步了解explain的详细用法，可以看看另一篇文章《[explain-索引优化](../../note/mysql/index/explain-索引优化.md)》
...
![png](images/1-skywalking架构图.png)
