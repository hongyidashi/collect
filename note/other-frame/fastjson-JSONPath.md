...
JSONPath是fastjson下的一个模块，主要用于对JSON格式的数据进行解析，本文主要介绍JSONPath的求值方法和语法，即：
...
fastjson1和2不完全兼容，相同的内容两个版本得到的结果可能不一致甚至报错，本文采用fastjson1，同时本文采用lombok插件，下面给出版本依赖：
...
建议先大致了解官方文档提供的语法后再来看本文，本文主要是对语法的一些demo
