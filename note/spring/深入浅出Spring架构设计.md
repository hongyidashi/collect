...
![png](images/3-S-RootBeanDefinition.svg)

> 里面的各种属性想必大家也绝不陌生(啊不，其实我挺陌生的。。。)

同样的，它也有许多实现类

![png](images/3-S-BeanDefinition.svg)
...
![png](images/3-S-ApplicationContext.svg)
