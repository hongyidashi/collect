...
- [一、背景知识](#%E4%B8%80%E8%83%8C%E6%99%AF%E7%9F%A5%E8%AF%86)
    - [1. 指令流水线](#1-%E6%8C%87%E4%BB%A4%E6%B5%81%E6%B0%B4%E7%BA%BF)
    - [2. cpu多级缓存](#2-cpu%E5%A4%9A%E7%BA%A7%E7%BC%93%E5%AD%98)
- [二、问题引入](#%E4%BA%8C%E9%97%AE%E9%A2%98%E5%BC%95%E5%85%A5)
    - [1. 原子性](#1-%E5%8E%9F%E5%AD%90%E6%80%A7)
    - [2. 可见性](#2-%E5%8F%AF%E8%A7%81%E6%80%A7)
    - [3. 顺序性](#3-%E9%A1%BA%E5%BA%8F%E6%80%A7)
- [三、JMM内存模型](#%E4%B8%89jmm%E5%86%85%E5%AD%98%E6%A8%A1%E5%9E%8B)
    - [1. 内存划分](#1-%E5%86%85%E5%AD%98%E5%88%92%E5%88%86)
    - [2. 内存间交互规则](#2-%E5%86%85%E5%AD%98%E9%97%B4%E4%BA%A4%E4%BA%92%E8%A7%84%E5%88%99)
        - [定义原子操作的使用规则](#%E5%AE%9A%E4%B9%89%E5%8E%9F%E5%AD%90%E6%93%8D%E4%BD%9C%E7%9A%84%E4%BD%BF%E7%94%A8%E8%A7%84%E5%88%99)
        - [long和double型变量的特殊规则](#long%E5%92%8Cdouble%E5%9E%8B%E5%8F%98%E9%87%8F%E7%9A%84%E7%89%B9%E6%AE%8A%E8%A7%84%E5%88%99)
    - [3. 先行发生原则](#3-%E5%85%88%E8%A1%8C%E5%8F%91%E7%94%9F%E5%8E%9F%E5%88%99)
- [四、问题解决](#%E5%9B%9B%E9%97%AE%E9%A2%98%E8%A7%A3%E5%86%B3)
    - [原子性](#%E5%8E%9F%E5%AD%90%E6%80%A7)
    - [2. 可见性](#2-%E5%8F%AF%E8%A7%81%E6%80%A7-1)
    - [3. 顺序性](#3-%E9%A1%BA%E5%BA%8F%E6%80%A7-1)
- [四、开发篇](#%E5%9B%9B%E5%BC%80%E5%8F%91%E7%AF%87)
    - [1. volatile](#1-volatile)
        - [顺序性](#%E9%A1%BA%E5%BA%8F%E6%80%A7)
        - [可见性](#%E5%8F%AF%E8%A7%81%E6%80%A7)
        - [实现原理](#%E5%AE%9E%E7%8E%B0%E5%8E%9F%E7%90%86)
    - [2. final](#2-final)
    - [3. synchronized](#3-synchronized)
        - [实现原理](#%E5%AE%9E%E7%8E%B0%E5%8E%9F%E7%90%86-1)
        - [关键结构](#%E5%85%B3%E9%94%AE%E7%BB%93%E6%9E%84)
        - [OS 互斥锁](#os-%E4%BA%92%E6%96%A5%E9%94%81)
...
由JMM的lock、unlock可实现更大范围的原子性保证，但是这是JVM需要实现支持的功能，对于开发者则是有由 **synchronized关键字** **或者 Lock读写锁** 来保证原子性。
...
- volatile 禁止指令重排序synchronized/Lock 

- 一个变量在同一个时刻只允许一条线程对其执行lock操作
...
![png](images/MarkWord结构示意图.png)

锁的状态共有 4 种:无锁、偏向锁、轻量级锁、重量级锁。随着竞争的增加，锁的使用情况如下：

> 无锁 -> 偏向锁 -> 轻量级锁 -> 重量级锁

其中偏向锁和轻量级锁是从 JDK 6 时引入的，在 JDK 6 中默认开启。
...
- 只有拥有锁的线程在释放锁时，并且在 EntryList 为空、ContentionList 不为空的情况下，才能将ContentionList 中的线程全部出队，放入到EntryList 中
