...
- [一、Kubernetes 网络基础](#%E4%B8%80kubernetes-%E7%BD%91%E7%BB%9C%E5%9F%BA%E7%A1%80)
    - [动态网络](#%E5%8A%A8%E6%80%81%E7%BD%91%E7%BB%9C)
    - [2. Service 带来稳定性](#2-service-%E5%B8%A6%E6%9D%A5%E7%A8%B3%E5%AE%9A%E6%80%A7)
    - [3. Kubernetes Service 解析](#3-kubernetes-service-%E8%A7%A3%E6%9E%90)
    - [小结](#%E5%B0%8F%E7%BB%93)
- [二、深入了解 Kubernetes 服务发现](#%E4%BA%8C%E6%B7%B1%E5%85%A5%E4%BA%86%E8%A7%A3-kubernetes-%E6%9C%8D%E5%8A%A1%E5%8F%91%E7%8E%B0)
    - [1. 服务注册](#1-%E6%9C%8D%E5%8A%A1%E6%B3%A8%E5%86%8C)
    - [2. Endpoint 对象](#2-endpoint-%E5%AF%B9%E8%B1%A1)
    - [3. 服务发现](#3-%E6%9C%8D%E5%8A%A1%E5%8F%91%E7%8E%B0)
...
![png](images/k8s-service解析示意图.png)
...
![png](images/k8s-service后端负载均衡示意图.png)

Kubernetes 自动为每个 Service 创建 Endpoints 对象。Endpoints 对象的职责就是保存一个符合 Service 标签选择器标准的 Pod 列表，这些 Pod 将接收来自 Service 的流量。

上面的图中，Service 会选择两个 Pod，并且还展示了 Service 的 Endpoints 对象，这个对象里包含了两个符合 Service 选择标准的 Pod 的 IP。
...
![png](images/k8s-生成iptables:IPVS流程.png)
...
![png](images/k8s-ClusterIP流量转发流程图.png)
