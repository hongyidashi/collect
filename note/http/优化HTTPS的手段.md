...
![png](images/优化HTTPS-Nginx-ssl_ecdh_curve 指令.png)
...
![png](images/优化HTTPS-Nginx-ssl_ciphers 指令.png)
...
![png](images/优化HTTPS-Pre-shared Key.png)

同样的，Pre-shared Key 也有重放攻击的危险：

![png](images/优化HTTPS-Pre-shared Key重放攻击.png)
