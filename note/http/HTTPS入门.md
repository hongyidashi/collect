...
- [一、TLS 握手过程](#%E4%B8%80tls-%E6%8F%A1%E6%89%8B%E8%BF%87%E7%A8%8B)
- [二、RSA 握手过程](#%E4%BA%8Crsa-%E6%8F%A1%E6%89%8B%E8%BF%87%E7%A8%8B)
    ...
    - [2.5. 客户端验证证书](#25-%E5%AE%A2%E6%88%B7%E7%AB%AF%E9%AA%8C%E8%AF%81%E8%AF%81%E4%B9%A6)
...
- [三、RSA 算法的缺陷](#%E4%B8%89rsa-%E7%AE%97%E6%B3%95%E7%9A%84%E7%BC%BA%E9%99%B7)
...
![png](images/HTTPS入门-TLS 的握手过程.png)
...
![png](images/HTTPS入门-TLS四次握手.png)

对应 Wireshark 的抓包，这有一幅图，你可以从下图很清晰地看到该过程：

![png](images/HTTPS入门-TLS四次握手图.png)
...
![png](images/HTTPS入门-TLS 第一次握手.png)
...
![png](images/HTTPS入门-TLS 第二次握手.png)
...
![png](images/HTTPS入门-TLS 第二次握手-发送证书.png)

随后，服务端发了「**Server Hello Done**」消息，目的是告诉客户端，我已经把该给你的东西都给你了，本次打招呼完毕。

![png](images/HTTPS入门-TLS 第二次握手-完毕.png)
...
![png](images/HTTPS入门-数字证书签发和验证流程.png)
...
![png](images/HTTPS入门-证书三层级认证.png)

操作系统里一般都会内置一些根证书，比如我的 MAC 电脑里内置的根证书有这么多：

![png](images/HTTPS入门-MAC 电脑里内置的根证书.png)

这样的一层层地验证就构成了一条信任链路，整个证书信任链验证流程如下图所示：

![png](images/HTTPS入门-证书信任链验证流程.png)
...
![png](images/HTTPS入门-TLS 第三次握手1.png)
...
![png](images/HTTPS入门-TLS 第三次握手2.png)

然后，客户端再发一个「**Encrypted Handshake Message（Finishd）**」消息，把之前所有发送的数据做个摘要，再用会话密钥（master secret）加密一下，让服务器做个验证，验证加密通信是否可用和之前握手信息是否有被中途篡改过。

![png](images/HTTPS入门-TLS 第三次握手3.png)
...
![png](images/HTTPS入门-DH密钥协商算法工作流程.png)
