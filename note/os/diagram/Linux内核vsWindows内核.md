...
- [一、内核](#%E4%B8%80%E5%86%85%E6%A0%B8)
- [二、Linux 的设计](#%E4%BA%8Clinux-%E7%9A%84%E8%AE%BE%E8%AE%A1)
    - [1. MutiTask](#1-mutitask)
    - [2. SMP](#2-smp)
    - [3. ELF](#3-elf)
    - [4. Monolithic Kernel](#4-monolithic-kernel)
- [三、Windows 设计](#%E4%B8%89windows-%E8%AE%BE%E8%AE%A1)
...
下图分别为宏内核、微内核、混合内核的操作系统结构：

![png](images/kernel-分别为宏内核、微内核、混合内核的操作系统结构.png)
