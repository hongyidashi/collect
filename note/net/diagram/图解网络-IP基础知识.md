...
![png](images/IP基础-IPv6 地址表示方法.png)

如果出现连续的 0 时还可以将这些 0 省略，并用两个冒号 「::」隔开。但是，一个 IP 地址中只允许出现一次两个连续的冒号。

![png](images/IP基础-Pv6 地址缺省表示方.png)
...
![png](images/IP基础-IPv6 中的单播通信.png)

### 7. IPv4 首部与 IPv6 首部

IPv4 首部与 IPv6 首部的差异如下图：

![png](images/IP基础-IPv4 首部与 IPv6 首部的差异.png)
...
![png](images/IP基础-ICMP 目标不可达消息.png)
...
![png](images/IP基础-常见的 ICMP 类型.png)
...
![png](images/IP基础-IGMP 常规查询与响应工作机制.png)
...
![png](images/IP基础-IGMPv2 离开组播组工作机制 情况1.png)
...
![png](images/IP基础-IGMPv2 离开组播组工作机制 情况2 .png)
