...
![png](images/TPC面试题三次握手避免历史连接.png)
...
![png](images/TPC面试题-两次握手会造成资源浪费.png)
...
![png](images/TPC面试题-SYN-Accpet-正常流程.png)
...
![png](images/TPC面试题-SYN-Accpet-应用程序过慢.png)
...
其定义在 Linux 内核代码里的名称为 TCP_TIMEWAIT_LEN，如果要修改 TIME_WAIT 的时间长度，只能修改 Linux 内核代码里 TCP_TIMEWAIT_LEN 的值，并重新编译 Linux 内核。
...
![png](images/TPC面试题-接收到历史数据的异常.png)
...
![png](images/TPC面试题-没有确保正常断开的异常.png)
