...
![png](images/TCP-UDP-TCP四次挥手.png)
...
![png](images/TCP-UDP-TCPMSS协商.png)

### 6. 窗口控制

TCP 是以 1 个段为单位，每发一个段进行一次确认应答。如果包的往返时间越长，通信性能就越低。

![png](images/TCP-UDP-TCP按数据包确认应答.png)
...
![png](images/TCP-UDP-TCP滑动窗口.png)
...
![png](images/TCP-UDP-TCP报文格式.png)
